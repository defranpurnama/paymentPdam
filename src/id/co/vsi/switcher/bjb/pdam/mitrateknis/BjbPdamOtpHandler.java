...
import static id.co.vsi.switcher.bjb.pdam.mitrateknis.Common.cValidMCAndIP;
...
public class BjbPdamOtpHandler extends BjbPdamMessageHandler {

    public BjbPdamOtpHandler(JSONPlugin pParentPlugin) {
        super(pParentPlugin);
    }
