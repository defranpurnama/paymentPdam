...
import static id.co.vsi.switcher.bjb.pdam.mitrateknis.Common.cValidInquiryModulParameter;

public class BjbPdamInquiryHandler extends BjbPdamMessageHandler {

    public BjbPdamInquiryHandler(JSONPlugin pParentPlugin) {
        super(pParentPlugin);
    }
    ...
    private JSONObject performInquiry(final JSONObject pRequestMessage, final String pRF) {
        return performPdamMessage(pRequestMessage, pRF, cInquiryProcessingCode);
    }
