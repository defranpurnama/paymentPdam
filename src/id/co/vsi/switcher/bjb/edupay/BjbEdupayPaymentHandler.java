...
import static id.co.vsi.switcher.bjb.edupay.Common.cValidPaymentModulParameter;
...
public class BjbEdupayPaymentHandler extends BjbEdupayMessageHandler {

    public BjbEdupayPaymentHandler(JSONPlugin pParentPlugin) {
        super(pParentPlugin);
    }
    ...
    private JSONObject performPdamPayment(final JSONObject pRequestMessage) {
        return performEDUPAYMessage(pRequestMessage, pRequestMessage.getString(cRFKey), cPaymentProcessingCode);
    }
