...
public class ReceiptFormat {
    ...
    public static String buildReceiptFormat(final JSONObject pMP, final JSONObject pResponseMessage, final String pFitur) {
        ...
        sb.append("<td style=\"width: 3%; text-align: center; font-size: 90%;\">:</td>");
        sb.append("<td style=\"width: 50%; text-align: left; font-size: 90%;\">").append(pMP.getString("REF_NUM")).append("</td>");
        sb.append("</tr>");
        ...
        sb.append("<tr class=\"dark\" style=\"height: 18px;\">");
        sb.append("<td style=\"width: 47%; text-align: right; font-size: 90%;\">Nama</td>");
        sb.append("<td style=\"width: 3%; text-align: center; font-size: 90%;\">:</td>");
        sb.append("<td style=\"width: 50%; text-align: left; font-size: 90%;\">").append(pMP.getString("NAMA_SISWA")).append("</td>");
        sb.append("</tr>");

        sb.append("<tr class=\"dark\" style=\"height: 18px;\">");
        sb.append("<td style=\"width: 47%; text-align: right; font-size: 90%;\">Fakultas</td>");
        sb.append("<td style=\"width: 3%; text-align: center; font-size: 90%;\">:</td>");
        sb.append("<td style=\"width: 50%; text-align: left; font-size: 90%;\">").append(pMP.getString("NAMA_FAKULTAS")).append("</td>");
        sb.append("</tr>");

        sb.append("<tr class=\"dark\" style=\"height: 18px;\">");
        sb.append("<td style=\"width: 47%; text-align: right; font-size: 90%;\">Jurusan</td>");
        sb.append("<td style=\"width: 3%; text-align: center; font-size: 90%;\">:</td>");
        sb.append("<td style=\"width: 50%; text-align: left; font-size: 90%;\">").append(pMP.getString("NAMA_JURUSAN")).append("</td>");
        sb.append("</tr>");

        sb.append("<tr class=\"dark\" style=\"height: 18px;\">");
        sb.append("<td style=\"width: 47%; text-align: right; font-size: 90%;\">Tahun Akademik</td>");
        sb.append("<td style=\"width: 3%; text-align: center; font-size: 90%;\">:</td>");
        sb.append("<td style=\"width: 50%; text-align: left; font-size: 90%;\">").append(pMP.getString("TAHUN_AKADEMIK")).append("</td>");
        sb.append("</tr>");
